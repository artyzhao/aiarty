window.STARS_DATA = {
  ...
  "sky": [
    ...
    {
      "title": "土星东天可见",
      "caption": "土星距日约155度，东天寻找即可。",
      "image": "stars/today-2.svg",
      "alt": "土星位于东天"
    },
    {
      "title": "海王星东天可见",
      "caption": "海王星距日约164度，东天寻找即可。",
  ...
  "aspects": [
    ...
    },
    {
      ...
      "orbUsed": 2.7,
      "orbMax": 6.0,
      "influence": "月亮刑天王星，情绪和变数容易别扭，宜放慢再决定。"
    },
    {
      "a": "木星",
      "b": "土星",
  ...
  "diary": {
    "blessing": "月亮才刚露面，看什么都想理顺。月亮靠近一颗亮星，突然的变化有点别扭，对自己好一点。",
    "mod1": {
      "kicker": "天文学 · 月相",
      "title": "新月",
      "line": "亮面 1% · 渐亏",
    ...
    "astronomy": [
      ...
      },
      {
        ...
        "label": "月与恒星",
        "title": "月近轩辕十四",
        "caption": "相距约9度，同在月旁夜空。",
        "detail": "轩辕十四是较亮的恒星，月明时需稍避月光再辨认。"
      },
      {
        "kind": "planet",
        "label": "行星可见",
        "title": "金星西天可见",
        "caption": "距日约42度，日落后于西天寻找。",
