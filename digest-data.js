    ...
    "sections": [
      {
        ...
        "title": "整体",
        "titleEn": "Overview",
        "text": "弗里达·卡罗的主轴是巨蟹太阳、金牛月亮、狮子上升：别人先看到自信外放的一面，心里其实更需要稳健务实的感觉，做选择时又常按细腻顾家的太阳来定方向。太阳在第11宫，成就感多半来自「社群愿景」。月亮在第10宫，心情也常跟「事业声望」绑在一起。此为昼生盘。",
        "textEn": "Sun in Cancer (house 11), Moon in Taurus (house 10), Leo rising — first impression radiant, inner need steady, will protective.",
        "verify": "事迹验证：把残体、身份与政治写进自画像，成为 20 世纪最可辨认的画家之一。",
        "verifyEn": "Life check: 把残体、身份与政治写进自画像，成为 20 世纪最可辨认的画家之一。"
      },
      {
        "id": "personality",
        "title": "性格",
        "titleEn": "Personality",
        "text": "性格底色：上升狮子给外界的第一印象是自信外放；月亮金牛管情绪习惯，偏稳健务实；太阳巨蟹管意志，做事时更细腻顾家。水星在狮子第12宫，思考和表达会往「内在修复」上靠。太阳与火星的冲相会写进性格里，成为别人一眼能感到的节奏。",
        "textEn": "Rising Leo (radiant); Moon Taurus (steady); Sun Cancer (protective).",
        "verify": "事迹验证：公开的烈性与戏谑，不回避痛苦与身体残缺。",
        "verifyEn": "Life check: 公开的烈性与戏谑，不回避痛苦与身体残缺。"
      },
      {
        "id": "career",
        "title": "事业",
        "titleEn": "Career",
        "text": "中天在金牛，公开成就的底色偏稳健务实；十宫主金星飞入第11宫（社群愿景），事业起伏常跟这里连在一起；十宫有月亮坐守，公开成绩主题会被点亮；太阳在巨蟹第11宫，干劲多半使在「社群平台、团队协作与组织型事业」上。适合方向：适合金融、地产、设计美学或靠耐心积累的实业。做事风格偏务实克制（六宫在摩羯）。太阳冲相火星带来张力，升迁路上宜耐得住磨。",
        "textEn": "MC in Taurus: 适合金融、地产、设计美学或靠耐心积累的实业 Tenth-ruler story sits in house 11.",
        "verify": "事迹验证：从墨西哥城走向巴黎、纽约展览，作品进入世界级美术馆。",
        "verifyEn": "Life check: 从墨西哥城走向巴黎、纽约展览，作品进入世界级美术馆。"
      },
      {
        "id": "wealth",
        "title": "财富",
        "titleEn": "Wealth",
        "text": "二宫在处女，钱袋脾气偏细致严谨；二宫主水星飞入第12宫（内在修复），进账松紧常跟这里连在一起；八宫有土星，共同财务或投资议题更醒目；金星在双子第11宫，花钱更听「朋友圈、社团、团队分红与人脉机会」的话。财富主要来自幕后、疗愈、隐秘渠道或需要独处的工作。对金钱的态度：精打细算，讨厌浪费。金星合相冥王星偏顺，合作或顺势进账更自然。",
        "textEn": "2nd house in Virgo. Money path leans on 幕后、疗愈、隐秘渠道或需要独处的工作.",
        "verify": "事迹验证：经济常依赖里维拉与赞助，并非商业流水线型富豪。",
        "verifyEn": "Life check: 经济常依赖里维拉与赞助，并非商业流水线型富豪。"
      },
      {
        "id": "love",
        "title": "感情",
        "titleEn": "Love",
        "text": "七宫在水瓶，伴侣性格偏性格独立理性，需要被尊重空间；七宫主土星飞入第8宫，相处重心常在「共享资源」；金星在双子第11宫，喜好滤镜偏灵活善言。金星合相冥王星偏顺，吸引与互动来得更自然。",
        "textEn": "7th house in Aquarius: partners tend to feel independent.",
        "verify": "事迹验证：与迭戈·里维拉结婚、离婚再婚，关系公开而反复。",
        "verifyEn": "Life check: 与迭戈·里维拉结婚、离婚再婚，关系公开而反复。"
      },
      {
        "id": "health",
        "title": "健康",
        "titleEn": "Health",
        "text": "六宫在摩羯，日常保养节奏偏务实克制；上升在狮子，体质底色偏自信外放；六宫主土星飞入第8宫，体能起伏常跟「共享资源」绑在一起；十二宫有水星，独处恢复与睡眠格外重要。日常更需留意骨骼关节、皮肤屏障与慢性劳损，宜保暖、量力运动。十二宫在巨蟹，休息不足时更易出现隐性疲惫。太阳冲相火星带来张力，压力大时身体会先报警。",
        "textEn": "6th house in Capricorn. Watch the body themes tied to Capricorn.",
        "verify": "事迹验证：车祸重伤后多次脊椎与截肢手术，仍坚持作画。",
  ...
  "astroEn": {
    ...
    "astronomy": [
      ...
      },
      {
        ...
        "caption": "About 56 degrees from the sun, look for it in the eastern sky before dawn."
      },
      {
